...
<body>
    ...
    <?php 
        echo "Aqui vai o primeiro texto!";
    ?>
    <br><br>
    ...
    <?php
        ...
        if($valorDado >= 0 && $valorDado <= 5){
            $txt_redirecionamento = "contrabandista_final_1.php";
        }
        if($valorDado >= 6 && $valorDado <= 15){
            $txt_redirecionamento = "contrabandista_2.php";
        }
        if($valorDado >= 16 && $valorDado <= 20){
            $txt_redirecionamento = "contrabandista_final_2.php";
        }
