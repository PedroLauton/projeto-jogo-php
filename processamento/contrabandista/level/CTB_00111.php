<?php
  ...
  if($valorDado <= 10) {
    $redirecionamento = "../final/CTB_00111A.php";
  }
  else {
    $redirecionamento = "../final/CTB_00111B.php";
  }

  $storyFile = fopen(CTB_111, "r") or die("Unable to open file!");
  $storyText = fread($storyFile,filesize(CTB_111));
  fclose($storyFile);
?>
