<?php
  ...
  if($valorDado <= 10) {
    $redirecionamento = "../final/CTB_00121A.php";
  }
  else {
    $redirecionamento = "../final/CTB_00121B.php";
  }

  $storyFile = fopen(CTB_121, "r") or die("Unable to open file!");
  $storyText = fread($storyFile,filesize(CTB_121));
  fclose($storyFile);
?>
