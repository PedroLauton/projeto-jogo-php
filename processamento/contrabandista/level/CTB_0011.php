<?php
  ...
  if($valorDado == 20) {
    $redirecionamento = "../final/CTB_0011F.php";
  }
  else if($valorDado <= 12) {
    $redirecionamento = "CTB_00111.php";
  }
  else {
    $redirecionamento = "CTB_00112.php";
  }

  $storyFile = fopen(CTB_11, "r") or die("Unable to open file!");
  $storyText = fread($storyFile,filesize(CTB_11));
  fclose($storyFile);
?>
