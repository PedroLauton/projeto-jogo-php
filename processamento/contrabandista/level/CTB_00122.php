<?php
  ...
  if($valorDado <= 10) {
    $redirecionamento = "../final/CTB_00122A.php";
  }
  else {
    $redirecionamento = "../final/CTB_00122B.php";
  }

  $storyFile = fopen(CTB_122, "r") or die("Unable to open file!");
  $storyText = fread($storyFile,filesize(CTB_122));
  fclose($storyFile);
?>
