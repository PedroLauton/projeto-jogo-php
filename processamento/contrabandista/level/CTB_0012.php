<?php
  ...
  if($valorDado == 20) {
    $redirecionamento = "../final/CTB_0012F.php";
  }
  else if($valorDado <= 12) {
    $redirecionamento = "CTB_00121.php";
  }
  else {
    $redirecionamento = "CTB_00122.php";
  }

  $storyFile = fopen(CTB_12, "r") or die("Unable to open file!");
  $storyText = fread($storyFile,filesize(CTB_12));
  fclose($storyFile);
?>
