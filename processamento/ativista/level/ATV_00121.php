<?php
  ...
  if($valorDado <= 10) {
    $redirecionamento = "../final/ATV_00121A.php";
  }
  else {
    $redirecionamento = "../final/ATV_00121B.php";
  }

  $storyFile = fopen(ATV_121, "r") or die("Unable to open file!");
  $storyText = fread($storyFile,filesize(ATV_121));
  fclose($storyFile);
?>
