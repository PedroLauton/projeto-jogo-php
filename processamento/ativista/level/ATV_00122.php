<?php
  ...
  if($valorDado <= 10) {
    $redirecionamento = "../final/ATV_00122A.php";
  }
  else {
    $redirecionamento = "../final/ATV_00122B.php";
  }

  $storyFile = fopen(ATV_122, "r") or die("Unable to open file!");
  $storyText = fread($storyFile,filesize(ATV_122));
  fclose($storyFile);
?>
