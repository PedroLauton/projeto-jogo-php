<?php
  ...
  if($valorDado <= 10) {
    $redirecionamento = "../final/ATV_00112A.php";
  }
  else {
    $redirecionamento = "../final/ATV_00112B.php";
  }

  $storyFile = fopen(ATV_112, "r") or die("Unable to open file!");
  $storyText = fread($storyFile,filesize(ATV_112));
  fclose($storyFile);
?>
