<?php
  ...
  if($valorDado == 1) {
    $redirecionamento = "../final/ATV_0011F.php";
  }
  else if($valorDado <= 12) {
    $redirecionamento = "ATV_00111.php";
  }
  else {
    $redirecionamento = "ATV_00112.php";
  }

  $storyFile = fopen(ATV_11, "r") or die("Unable to open file!");
  $storyText = fread($storyFile,filesize(ATV_11));
  fclose($storyFile);
?>
