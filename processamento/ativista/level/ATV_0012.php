<?php
  ...
  if($valorDado == 1) {
    $redirecionamento = "../final/ATV_0012F.php";
  }
  else if($valorDado <= 12) {
    $redirecionamento = "ATV_00121.php";
  }
  else {
    $redirecionamento = "ATV_00122.php";
  }

  $storyFile = fopen(ATV_12, "r") or die("Unable to open file!");
  $storyText = fread($storyFile,filesize(ATV_12));
  fclose($storyFile);
?>
